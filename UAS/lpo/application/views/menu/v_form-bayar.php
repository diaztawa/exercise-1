...
<head>
    <title>Form Input Penggunaan</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" style="color:white;">Konfirmasi Pembayaran</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body" style="background-color:black; color:white;">
                            <div class="row">
                                <div class="col-lg-12">
                                    <?php echo form_open('admin/pembayaran/bayar'); ?>
                                    <?php $jumlah_meter= ($customer_list['jumlah_meter']*$customer_list['tarifperkwh']); ?>
                                        <input name="id_pelanggan" value="<?php echo $customer_list['id_pelanggan']?>" type="hidden">
                                        <input name="status" value="Lunas" type="hidden">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="<?php echo $customer_list['jumlah_meter'] ?>" name="jumlah_meter">
                                        </div>
                                        <div class="form-group">
                                            <label>Total Harga</label>
                                            <input class="form-control" value="<?php echo 'Rp.', $jumlah_meter ?>" name="meterakhir">
                                        </div>
                                        <div>
                                    ...
                                    <a href="<?php echo base_url('index.php/admin/pembayaran'); ?>"class="btn btn-danger btn-block col-lg-6">Batal</a>
                                </form>
                            </div>
                        </div>
                    </div>
